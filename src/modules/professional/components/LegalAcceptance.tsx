          ...
          <>
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
                🤖 CRITICAL: AI-Generated Content Warning
              </h1>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-4 mb-6">
              <p className="text-red-300 font-bold text-center">
                ⚠️ This application was created using AI and contains AI features
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6 mb-6 max-h-96 overflow-y-auto custom-scrollbar">
              <div className="space-y-4 text-sm text-white/80">
                <div>
                  <h3 className="font-bold text-red-400 mb-2">🤖 App Created Using AI</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold text-red-400 mb-2">🚫 AI Cannot Be Trusted for Accuracy</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold text-red-400 mb-2">✅ Your Complete Responsibility</h3>
                ...
                <div>
                  <h3 className="font-bold text-red-400 mb-2">❌ NEVER Do This</h3>
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4">
                  <p className="text-red-300 font-semibold text-center text-xs">
                    ⚠️ AI is a tool to ASSIST you, not REPLACE your professional judgment.<br/>
            ...
            <p className="text-xs text-white/40 text-center mt-4">
              3 more steps: Disclaimer → Terms → Knowledge Quiz (earn up to 4,550 XP!)
            </p>
          </>
        )}
        ...
        {currentStep === 'disclaimer' && (
          <>
            ...
            <div className="bg-white/5 rounded-2xl border border-white/10 p-6 mb-6 max-h-96 overflow-y-auto custom-scrollbar">
              <div className="space-y-4 text-sm text-white/80">
                <div>
                  <h3 className="font-bold text-white mb-2">🚨 Not Officially Endorsed</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold text-white mb-2">📋 Not Official CPD Records</h3>
                  <p>
                ...
                <div>
                  <h3 className="font-bold text-white mb-2">✅ Your Responsibilities</h3>
                  <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <div>
                  <h3 className="font-bold text-white mb-2">⚠️ No Warranties</h3>
                  <p>
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4">
                  <p className="text-amber-200 font-semibold text-center">
                    ⚠️ Use at your own discretion. Always verify requirements with your regulatory body.
                  </p>
                </div>
              </div>
            </div>
